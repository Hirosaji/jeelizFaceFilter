...
var SETTINGS = {
    ...
    scale: [2.1, 2.1], //scale of the DIV along horizontal and vertical axis
    positionOffset: [0, 0.8, -0.25] //set a 3D position fofset to the div
};
